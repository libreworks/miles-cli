...
const NAMESPACE = "auth.cognito";

/**
 * Stores cognito credentials using the SecretService.
 *
 * The amazon-cognito-identity-js library allows for custom storage of auth data
 * (by default, it has a memory-based store and one for browser local storage).
 * This class implements the same API.
 */
