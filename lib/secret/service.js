...
class SecretService {
   ...
   *
   * @param {string} namespace - The namespace of the key to remove
   * @param {string} key - The key remove
   */
  remove(namespace, key) {
    this[SECRETS].remove(namespace, key);
  }

  /**
   * Remove all secrets in a namespace.
   *
   * @param {string} namespace - The namespace of the values to clear
   */
  clear(namespace) {
    this[SECRETS].clear(namespace);
  }
